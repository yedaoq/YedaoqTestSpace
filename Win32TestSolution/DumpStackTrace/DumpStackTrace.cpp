// DumpStackTrace.cpp : 定义应用程序的入口点。
//

#include "stdafx.h"
#include "DumpStackTrace.h"
                     ...
                     int       nCmdShow)
{
	...
	TCHAR dump_dir[2048];
	GetModuleFileName(hInstance, dump_dir, ARRAYSIZE(dump_dir) - 1);
	...
	LoadString(hInstance, IDC_DUMPSTACKTRACE, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_DUMPSTACKTRACE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_DUMPSTACKTRACE));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_DUMPSTACKTRACE);
